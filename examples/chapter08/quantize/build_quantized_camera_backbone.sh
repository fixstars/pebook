...
# build trt engine
trtexec --onnx=./model/resnet50/camera.backbone.onnx --int8 \
...
nsys profile -o prof_quantized  --force-overwrite true ./build/bevfusion $DEBUG_DATA $DEBUG_MODEL $DEBUG_PRECISION
